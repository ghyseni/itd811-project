...
public class TicketDAO {
	...
	// INSERT a ticket
	// *************************************
	public static void insertTicket(String name, String description, String department, int issuerId, int userId)
			throws SQLException, ClassNotFoundException {
		// Declare a DELETE statement
		String updateStmt = "INSERT INTO tickets " + "(name, description, department, issuer_id, user_id) " + "VALUES "
				+ "('" + name + "','" + description + "','" + department + "'," + issuerId + "," + userId + ")";
